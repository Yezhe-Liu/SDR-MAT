...
% rx_signal_fine=round(rx_signal_fine./32);
...
% m = csvread('..\data\20170414\data11.csv',1,0);
% d2_q=m(1:end,7);
% d2_i=m(1:end,8);
% data_pten=m(1:end,6);
% data_pt=d2_i+1i*d2_q;
% index=find(data_pten~=0);
% data_pt=data_pt(index(1):index(1)+47).*2^9;
%% signal
%get the signal part
