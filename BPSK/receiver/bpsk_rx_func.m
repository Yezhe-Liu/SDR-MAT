function [ rx_info ] = bpsk_rx_func(rxdata, samp_rate)

rx_info = struct( 'modulationOrder', 2, ...
                  'len_preamble', 64, ...
...
[rx_sig_carrier_sync, rx_info] = rx_carrier_sync(sig_coarse_freq_sync(1:100*120+16), rx_info);

[rx_sig_equalized, rx_info] = rx_time_equalize(rx_sig_carrier_sync, rx_info);

bitout = demod_dbpsk(rx_info.InitState, rx_sig_equalized);
